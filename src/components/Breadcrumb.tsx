...
import { HomeFilled, ShopFilled, FileTextFilled, UserOutlined, UserAddOutlined, RollbackOutlined, ApartmentOutlined, CreditCardFilled } from "@ant-design/icons";
...
const Breadcrumb: React.FC<BreadcrumbProps> = ({ items }) => {
  const getIcon = (label: string) => {
    switch (label) {
      ...
      case "ادارة الفروع":
        return <ApartmentOutlined className="text-blue-400 mr-2 rtl:ml-2" />;
      case "فاتورة مبيعات":
        return <ShopFilled className="text-blue-400 mr-2 rtl:ml-2" />;
      case "مرتجع مبيعات":
        return <RollbackOutlined className="text-blue-400 mr-2 rtl:ml-2" />;
      case "ادارة طرق الدفع":
        return <CreditCardFilled className="text-blue-400 mr-2 rtl:ml-2" />;
      default:
        return null;
    }
  };

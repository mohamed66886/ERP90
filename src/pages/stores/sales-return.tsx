...
const SalesReturnPage: React.FC = () => {
  ...
  const tableRowVariants = {
    ...
    >
      {/* Global Cairo font style */}
      {typeof document !== 'undefined' && !document.getElementById('cairo-font-global') && (
        <style id="cairo-font-global">
          {`
      ...
      >
        <div style={{ 
          ...
          >
            <ArrowLeftOutlined style={{ fontSize: 24, color: '#305496' }} />
          </motion.div>
          <h1 style={{ 
